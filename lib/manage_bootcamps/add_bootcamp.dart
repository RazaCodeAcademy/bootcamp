...
class AddBootcamp extends StatefulWidget {
  const AddBootcamp({super.key});

  @override
  State<AddBootcamp> createState() => _AddBootcampState();
}

class _AddBootcampState extends State<AddBootcamp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ProgressHUD(
        ...
        child: Form(
          key: globalFormKey,
          child: _addBootcampUI(context),
        ),
      ),
    );
  }

  Widget _addBootcampUI(BuildContext context) {
    var size = MediaQuery.of(context).size;
    return Padding(
            ...
            ElevatedButton(
              ...
              if (validateAndSave()) {
                setState(() {
                  ...
                  BootcampService.addBootcamp(model).then((response) => {
                        setState(() {
